        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="loan-info">
                    ...
                    <p>Name of Lender: <span id="modalLenderName"></span></p>
                ...
                <h6 class="section-titles">Payment Details</h6>
                <div class="payment-details">
                    <p>Transaction Deadlines: <span id="modalDeadlines"></span></p>
                    <p>Loan Amount: <span id="modalOtherone"></span></p>
                    <p>Status: <span id="stats"></span></p>
                </div>
...
function performAction(transactionId) {
    ...
    fetch(`get_loan_details.php?transaction_id=${transactionId}`)
        ...
        .then(data => {
            ...
            document.getElementById('stats').textContent = data.status;
